...
export default function QuickAnswersSection() {
    // Icon mapping for each answer format
    const iconMap = {
        definition: <Zap className="w-5 h-5 text-primary" />,
        rich: <Layers className="w-5 h-5 text-blue-500" />,
        examples: <Code className="w-5 h-5 text-purple-500" />,
        comparison: <GitCompare className="w-5 h-5 text-green-500" />,
    };
