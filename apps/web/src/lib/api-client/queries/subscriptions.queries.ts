...
export const getSubscriptionStatus = async (): Promise<GetSubscriptionStatusResponse> => {
...
export const createPortalSession = async (): Promise<CreatePortalResponse> => {
 ...
 */
export const subscriptionStatusQueryOptions = () => queryOptions({
