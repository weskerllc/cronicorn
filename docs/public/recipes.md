...
The configurations below show JSON field names that map directly to the Web UI form fields, MCP Server parameters, and HTTP API request bodies. See [Core Concepts](./core-concepts.md#endpoint-configuration-schema-json) for the full schema reference.
