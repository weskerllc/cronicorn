...
/** Zod schema type for tool parameter validation */
export type ToolSchema<T = unknown> = z.ZodSchema<T>;
...
/** Type-safe tool definition with schema inference */
export type ToolDefinition<TSchema extends z.ZodSchema = z.ZodAny> =
    | {
        description?: string;
